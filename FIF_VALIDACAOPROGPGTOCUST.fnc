-- Adicionado tabela de controle para liberação atraves de query view:

CREATE TABLE NAGT_LIB_CRIT_PROG (NROEMPRESA NUMBER(3), NROTITULO NUMBER(13), DATALIB DATE, USUARIO_LIB VARCHAR2(3000));
